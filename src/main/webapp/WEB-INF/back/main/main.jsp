		...
		<script type="text/javascript">
				  ...
				  <!-- <li><a href="javascript:void(0)" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 店铺管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="javascript:void(0)" name="ShopAuditServlet.do" title="店铺审核" class="iframeurl"><i class="icon-double-angle-right"></i>店铺审核<span class="badge badge-danger"></span></a></li>
							</ul>
						</li> -->
