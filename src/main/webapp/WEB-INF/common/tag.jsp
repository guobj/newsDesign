...
#jsddm ul li{ float:left; width:105px; padding-left:20px; line-height:40px;}
            ...
            <li class="nav-news"><a href="ArticleTypeServlet.so?id=1" target="_blank">国际<span class="nums-prompt nums-prompt-topic"></span></a></li>
            <li class="nav-news"><a href="ArticleTypeServlet.so?id=2" target="_blank">政治</a></li>
            <li class="nav-news"><a href="ArticleTypeServlet.so?id=3" target="_blank">经济<span class="nums-prompt"></span></a></li>
            <li class="nav-news"><a href="ArticleTypeServlet.so?id=4" target="_blank">娱乐<em class="nums-prompt"></em></a></li>
            <li class="nav-news"><a href="ArticleTypeServlet.so?id=5" target="_blank">军事</a></li>
        </ul>
